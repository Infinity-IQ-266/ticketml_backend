...
@Component("ticketTypeConverter")
public class TicketTypeConverter extends Super2Converter<TicketTypeRequestDTO, TicketTypeResponseDTO, TicketType> {


    private final ModelMapper modelMapper;

    public TicketTypeConverter(ModelMapper modelMapper) {
