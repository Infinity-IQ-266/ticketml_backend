...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    Page<Order> findOrdersByOrganizationId(@Param("orgId") Long orgId, Pageable pageable);
    ...
    @Query("SELECT COUNT(o) FROM Order o JOIN o.orderItems oi JOIN oi.ticketType tt JOIN tt.event e " +
            "WHERE e.organization.id = :orgId AND o.status = 'CONFIRMED'")
    Long countOrdersByOrganizationId(@Param("orgId") Long orgId);
}
